...
console.log(`✅ iPhone live reload URL: ${nativeUrl}`);
...
console.log("\n✅ Låt den här terminalen vara öppen. Ändringar i React/CSS/TS laddas från din Mac till iPhone.");
console.log("Om iPhone inte når servern: kontrollera samma WiFi eller kör CAP_DEV_HOST=<din-ip> npm run cap:dev:ios");
