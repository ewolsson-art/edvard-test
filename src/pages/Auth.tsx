          ...
          <div className="flex items-end gap-6 md:gap-10 animate-fade-in">
            ...
            <div className="space-y-3 md:space-y-6 max-w-xl">
              <h1 className="text-[1.75rem] sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white leading-[1.15] tracking-tight drop-shadow-lg">
                ...
                <span className="text-[hsl(265_55%_58%)]">bättre insikt</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4 pt-1 md:pt-2">
                <button
                  className="px-8 md:px-10 py-3 md:py-3.5 rounded-full bg-[hsl(265_55%_58%)] text-[hsl(225_30%_7%)] font-semibold text-[0.95rem] md:text-base tracking-wide shadow-[0_4px_20px_hsl(260_60%_72%/0.3)] hover:shadow-[0_6px_28px_hsl(260_60%_72%/0.45)] hover:scale-105 active:scale-[0.98] transition-all duration-200"
