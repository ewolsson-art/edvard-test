          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            {isSuccess ? (
              <div className="text-center space-y-6 py-4">
                ...
                <Button
                  className="w-full bg-[hsl(260_60%_72%)] text-[hsl(230_30%_5%)] hover:bg-[hsl(260_60%_80%)]"
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    className="w-full h-11 rounded-xl font-medium bg-[hsl(260_60%_72%)] text-[hsl(230_30%_5%)] hover:bg-[hsl(260_60%_80%)]"
                    disabled={isSubmitting}
                  >
