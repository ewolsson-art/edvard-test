            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 p-8 md:p-10 text-center animate-fade-in">
              <div className="flex justify-center mb-6 relative">
                ...
                <div className="h-16 w-16 rounded-full bg-[hsl(260_60%_72%/0.15)] flex items-center justify-center relative">
                  <CheckCircle2 className="h-8 w-8 text-[hsl(265_55%_58%)] animate-scale-in" />
                </div>
              </div>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="flex justify-center mb-4 animate-fade-in" role="progressbar" aria-valuenow={currentStepIndex + 1} aria-valuemin={1} aria-valuemax={2} aria-label={`Steg ${currentStepIndex + 1} av 2`}>
            <div className="flex items-center gap-3">
              ...
              <div className={cn(
                ...
                step === "role" ? "bg-[hsl(265_55%_58%)] text-[hsl(230_30%_5%)] shadow-md shadow-[hsl(260_60%_72%/0.3)]" : "bg-white/10 text-white/60"
              )} aria-hidden="true">
                1
              </div>
              <div className={cn(
                "w-12 h-1 rounded-full transition-all duration-500",
                step === "details" || step === "submitting" ? "bg-[hsl(265_55%_58%)]" : "bg-white/15"
              )} aria-hidden="true" />
              <div className={cn(
                "w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold transition-all duration-300",
                step === "details" || step === "submitting" ? "bg-[hsl(265_55%_58%)] text-[hsl(230_30%_5%)] shadow-md shadow-[hsl(260_60%_72%/0.3)]" : "bg-white/10 text-white/30"
              )} aria-hidden="true">
                2
              </div>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 p-5 md:p-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            {step === "role" && (
              <div className="animate-fade-in" role="group" aria-labelledby="role-heading">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected 
                            ? "border-[hsl(265_55%_58%)] bg-[hsl(260_60%_72%/0.1)] shadow-md shadow-[hsl(260_60%_72%/0.1)]" 
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className={cn(
                            ...
                            isSelected ? "bg-[hsl(265_55%_58%)] text-[hsl(230_30%_5%)]" : "bg-white/10 text-white/60 group-hover:bg-white/15"
                          )} aria-hidden="true">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <h3 className={cn(
                                ...
                                isSelected ? "text-[hsl(265_55%_58%)]" : "text-white"
                              )}>
                                {info.title}
                              </h3>
                              {isSelected && (
                                <CheckCircle2 className="h-4 w-4 text-[hsl(265_55%_58%)] animate-scale-in" aria-hidden="true" />
                              )}
                            </div>
                ...
                <Button
                  ...
                  disabled={!role}
                  className="w-full h-11 rounded-xl text-sm font-semibold bg-[hsl(265_55%_58%)] text-[hsl(230_30%_5%)] hover:bg-[hsl(265_55%_68%)] shadow-lg shadow-[hsl(260_60%_72%/0.2)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 group mt-5"
                >
                  Fortsätt
            ...
            {(step === "details" || step === "submitting") && (
              <div className="animate-fade-in" role="group" aria-labelledby="details-heading">
                <div className="flex flex-col items-center mb-4">
                  {role && (
                    <div className={cn(
                      "w-11 h-11 rounded-xl flex items-center justify-center mb-3 bg-[hsl(265_55%_58%)] text-[hsl(230_30%_5%)]"
                    )} aria-hidden="true">
                      {(() => {
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="space-y-3" aria-label="Registreringsformulär">
                  ...
                  <div className="flex gap-2 pt-1">
                    ...
                    <Button
                      type="submit"
                      className="flex-1 h-10 rounded-lg text-sm font-semibold bg-[hsl(265_55%_58%)] text-[hsl(230_30%_5%)] hover:bg-[hsl(265_55%_68%)] shadow-lg shadow-[hsl(260_60%_72%/0.2)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 group"
                      disabled={isSubmitting}
                    >
                      {isSubmitting ? (
            ...
            <div className="text-center">
              ...
              >
                Har du redan ett konto? <span className="text-[hsl(265_55%_58%)] font-semibold">Logga in</span>
              </Link>
            </div>
          </div>
