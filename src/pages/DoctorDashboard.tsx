    ...
    <div className="py-8 px-4 md:px-8">
      <div className="max-w-6xl mx-auto space-y-8">
        <header className="flex items-start justify-between">
          <div>
            <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">Mina användare</h1>
            <p className="text-muted-foreground">Översikt över personer som delar sin data med dig.</p>
          </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-display text-2xl font-semibold">Användare</h2>
