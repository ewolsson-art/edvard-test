        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 space-y-3 animate-fade-in">
            ...
            <button
              ...
              className="w-full h-13 rounded-2xl bg-white/[0.06] ring-1 ring-white/[0.08] hover:ring-white/[0.16] hover:bg-white/[0.10] text-white text-[15px] font-medium flex items-center justify-center gap-3 transition-all duration-200"
            >
