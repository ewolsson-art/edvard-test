...
import { CalendarDays, BarChart3, LogOut, UserCircle, Users, Home, FileText, Settings, MessageCircle, Bell, Sparkles, Stethoscope, Loader2, Bot, Activity, Shield } from "lucide-react";
  ...
  if (isAdmin) {
    navGroups = [
      ...navGroups,
      {
        ...
        items: [
          { titleKey: "sidebar.adminDashboard", url: "/admin", icon: Shield },
        ],
      },
    ];
  }
