          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-1 ml-auto">
              ...
              <button
                ...
                className="ml-3 px-5 py-2 text-sm font-semibold text-[hsl(225_30%_7%)] bg-[hsl(265_55%_58%)] rounded-full hover:bg-[hsl(265_55%_68%)] hover:scale-105 active:scale-[0.98] transition-all duration-200 shadow-[0_2px_12px_hsl(260_60%_72%/0.25)]"
              >
                Logga in
              </button>
            </div>
